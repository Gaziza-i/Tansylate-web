  ...
  return (
    <section className="flex flex-col py-20 px-4 md:px-6 bg-[#F5F7D0]">
      <div className="max-w-7xl mx-auto w-full flex flex-col">
        <h2 className="text-[34px] md:text-[40px] font-normal uppercase tracking-wide text-[#2C2A29] mb-15 min-[1000px]:mb-20 text-center">Нас носят блогеры</h2>
      ...
      <div className="min-h-screen bg-[#F5F7D0]">
        ...
        <main className="pt-24 lg:pt-28">
          <section className="min-h-[calc(100vh-88px)] flex flex-col items-center justify-center text-center px-4">
            ...
            <h1 className="text-[32px] sm:text-[42px] md:text-[52px] lg:text-[62px] font-normal uppercase tracking-wide text-[#2C2A29] mb-6">{heroS.title}</h1>
          ...
          <section id="trust" className="flex flex-col py-20 px-4 md:px-6 bg-[#F5F7D0] scroll-mt-24 lg:scroll-mt-28">
            <div className="max-w-7xl mx-auto w-full flex flex-col">
              <h2 className="text-[34px] md:text-[40px] font-normal uppercase tracking-wide text-[#2C2A29] mb-15 min-[1000px]:mb-20 text-center">Почему нам верят</h2>
          ...
          <section id="delivery" className="flex flex-col py-20 px-4 md:px-6 bg-[#F5F7D0] scroll-mt-24 lg:scroll-mt-28">
            <div className="max-w-5xl mx-auto w-full flex flex-col">
              <h2 className="text-[34px] md:text-[40px] font-normal uppercase tracking-wide text-[#2C2A29] mb-15 min-[1000px]:mb-20 text-center">{deliveryS.title}</h2>
