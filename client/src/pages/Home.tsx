    ...
    <section id="about" className="flex items-center bg-[#F5F7D0] overflow-hidden scroll-mt-24 lg:scroll-mt-28">
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 w-full">
        <div className="py-20 px-8 md:px-16 flex flex-col justify-center">
          <h2 className="text-[34px] md:text-[40px] font-normal uppercase tracking-wide text-[#2C2A29] mb-12 text-center">{about.title}</h2>
  ...
  return (
    <section className="flex flex-col py-20 px-4 md:px-6 bg-[#F5F7D0]">
      <div className="max-w-7xl mx-auto w-full flex flex-col">
        <h2 className="text-[34px] md:text-[40px] font-normal uppercase tracking-wide text-[#2C2A29] mb-12 text-center">Нас носят блогеры</h2>
        ...
        <main className="pt-24 lg:pt-28">
          ...
          <section id="catalog" className="min-h-screen flex flex-col py-20 px-4 md:px-6 bg-[#F5F7D0] scroll-mt-24 lg:scroll-mt-28">
            <div className="max-w-7xl mx-auto w-full flex flex-col flex-1">
              <h2 className="text-[34px] md:text-[40px] font-normal uppercase tracking-wide text-[#2C2A29] mb-12 text-center">Каталог</h2>
              ...
              <div className="flex-1 flex flex-col justify-center">
                <div className="mb-12 relative max-w-xl mx-auto w-full">
                  ...
                  <input
                    ...
                    className="w-full pl-12 pr-4 py-3 border border-[#DDD5C0] rounded-xl focus:outline-none focus:border-[#1A1A1A] bg-white"
                  />
                </div>
          ...
          <section id="trust" className="flex flex-col py-20 px-4 md:px-6 bg-[#F5F7D0] scroll-mt-24 lg:scroll-mt-28">
            <div className="max-w-7xl mx-auto w-full flex flex-col">
              <h2 className="text-[34px] md:text-[40px] font-normal uppercase tracking-wide text-[#2C2A29] mb-12 text-center">Почему нам верят</h2>
          ...
          <section id="looks" className="flex flex-col py-20 px-4 md:px-6 bg-[#F5F7D0] scroll-mt-24 lg:scroll-mt-28">
            <div className="max-w-7xl mx-auto w-full flex flex-col">
              <h2 className="text-[34px] md:text-[40px] font-normal uppercase tracking-wide text-[#2C2A29] mb-12 text-center">{looksS.title}</h2>
          ...
          <section id="delivery" className="flex flex-col py-20 px-4 md:px-6 bg-[#F5F7D0] scroll-mt-24 lg:scroll-mt-28">
            <div className="max-w-5xl mx-auto w-full flex flex-col">
              <h2 className="text-[34px] md:text-[40px] font-normal uppercase tracking-wide text-[#2C2A29] mb-12 text-center">{deliveryS.title}</h2>
