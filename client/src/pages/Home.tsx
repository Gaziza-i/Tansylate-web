    ...
    <section id="about" className="min-h-screen flex items-start md:items-stretch bg-[#F5F7D0] overflow-hidden">
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 w-full">
        <div className="py-20 px-8 md:px-16 flex flex-col justify-start">
          <h2 className="text-3xl md:text-4xl font-serif font-normal uppercase tracking-wide text-[#2B2521] mb-6">{about.title}</h2>
  ...
  return (
    <section className="min-h-screen flex flex-col justify-start py-20 px-4 md:px-6 bg-[#F5F7D0]">
      <div className="max-w-7xl mx-auto">
        <h2 className="text-3xl md:text-4xl font-serif font-normal uppercase tracking-wide text-[#2B2521] mb-10 text-center">Нас носят блогеры</h2>
      ...
      <div className="min-h-screen bg-[#F5F7D0]">
        ...
        <main className="pt-24 lg:pt-28">
          <section className="min-h-[calc(100vh-88px)] flex flex-col items-center justify-center text-center px-4">
            ...
            <h1 className="text-5xl md:text-6xl font-serif font-normal uppercase tracking-wide text-[#2B2521] mb-6">{heroS.title}</h1>
          ...
          <section id="catalog" className="min-h-screen flex flex-col justify-start py-20 px-4 md:px-6 bg-[#EEE8D2]">
            <div className="max-w-7xl mx-auto">
              <h2 className="text-3xl md:text-4xl font-serif font-normal uppercase tracking-wide text-[#2B2521] mb-8 text-center">Каталог</h2>
          ...
          <section id="trust" className="min-h-screen flex flex-col justify-start py-20 px-4 md:px-6 bg-[#EEE8D2]">
            <div className="max-w-7xl mx-auto">
              <h2 className="text-3xl md:text-4xl font-serif font-normal uppercase tracking-wide text-[#2B2521] mb-12 text-center">Почему нам верят</h2>
          ...
          <section id="looks" className="min-h-screen flex flex-col justify-start py-20 px-4 md:px-6 bg-[#EEE8D2]">
            <div className="max-w-7xl mx-auto">
              <h2 className="text-3xl md:text-4xl font-serif font-normal uppercase tracking-wide text-[#2B2521] mb-4 text-center">{looksS.title}</h2>
          ...
          <section id="delivery" className="min-h-screen flex flex-col justify-start py-20 px-4 md:px-6 bg-[#F5F7D0]">
            <div className="max-w-5xl mx-auto">
              <h2 className="text-3xl md:text-4xl font-serif font-normal uppercase tracking-wide text-[#2B2521] mb-12 text-center">{deliveryS.title}</h2>
    ...
    return (
      <div className="min-h-screen bg-[#F5F7D0] flex flex-col">
        ...
        <main className="flex-1 max-w-4xl mx-auto w-full px-4 md:px-6 pt-28 lg:pt-32 pb-12">
          ...
          <h1 className="text-3xl md:text-4xl font-serif font-normal uppercase tracking-wide text-[#2B2521] mb-8">Политика конфиденциальности</h1>
